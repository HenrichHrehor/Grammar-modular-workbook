...
const src = path.join(__dirname, "..", "Grammar text_Html codes", "Past continuous.txt");
...
const parts = [
  ...
  "  <title>Past Continuous — Grammar</title>",
  ...
  '      <a href="past-continuous-grammar.html" class="nav-btn active">📚 Grammar</a>',
  "    </div>",
  '    <div class="nav-right">',
  ...
  '    <a href="../practice/past-continuous-exercises.html?level=b1">B1 Past Continuous Exercises</a> ·',
